...
ContactList.propTypes = {
	...
	// Also the special id type which can be used to select some other piece of content (by contactList name), like this:
...
ContactList.icon='align-center'; // fontawesome icon
*/